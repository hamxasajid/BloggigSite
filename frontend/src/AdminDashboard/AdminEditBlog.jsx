...
import "./AdminEditBlog.css"; // Custom CSS file
    ...
    <div className="admin-edit-blog-container">
      <div className="admin-edit-blog-header">
        <div className="container">
          <h1 className="admin-edit-blog-title">Admin: Edit Blog Post</h1>
      ...
      <div className="container admin-edit-blog-form-container">
        <div className="admin-edit-blog-card">
          {error && (
            <div
